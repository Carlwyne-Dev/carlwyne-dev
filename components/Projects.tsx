...
const projects: Project[] = [
  ...
  {
    name: "Viper",
    type: "CLI Security Recon Toolkit",
    year: "2026",
    desc: "A powerful Python CLI tool covering port scanning, DNS recon, subdomain enumeration, OSINT, and vulnerability scanning.",
