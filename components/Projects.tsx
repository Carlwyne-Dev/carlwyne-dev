...
const projects = [
  {
    ...
    year: "2025–26",
    desc: "A full water billing management system featuring a mobile reader app, admin dashboard, and cashier payment processing. Collaborative solo project for 5-6 staff members.",
    link: null,
    category: "actual",
    images: ["/pr/water.jpg"],
  },
  {
    ...
    type: "AI Career Tool",
    year: "2026",
    desc: "AI-powered web app that maps skills and surfaces relevant income and career paths with integrated decision logic.",
  ...
  },
  {
    ...
    type: "Mobile App",
    year: "2024–26",
    desc: "Time-locked journaling app that only unlocks between 12:00 AM and 4:00 AM for distraction-free thought release.",
  ...
  },
  {
    ...
    type: "Mobile POS",
    year: "2026",
    desc: "Full retail POS mobile app featuring stock management, credit tracking, and expense monitoring. Built for diverse retail types.",
    link: null,
    wip: true,
    category: "actual",
